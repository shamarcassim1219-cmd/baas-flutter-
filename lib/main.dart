  ...
  Future<void> _check() async {
    try {
      ...
      if (loggedIn) {
        ...
        // Re-sync the local language choice to the backend on every
        // startup for an already-logged-in account - covers anyone
        // who picked their language before registering (when there
        // was no session yet to attach it to) or from before this
        // sync existed at all.
        locale.syncToBackend();
      }
