...
class OtpScreen extends StatefulWidget {
  ...
  const OtpScreen({super.key, required this.mobile, required this.isNewAccount, this.referralCode});
...
class _OtpScreenState extends State<OtpScreen> {
  ...
  Future<void> _resend() async {
    ...
    try {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(content: Text(t('codeSentAgain'))),
      );
      _startResendCooldown();
  ...
  Future<void> _verify() async {
    ...
    try {
      widget.isNewAccount
          ? await AuthService.instance.verifyRegisterOtp(widget.mobile, otp, referralCode: widget.referralCode)
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              Text(t('enterVerificationCode'), style: Theme.of(context).textTheme.headlineMedium)
                  .animate().fadeIn(delay: 100.ms),
              const SizedBox(height: 6),
              Text(
                '${t('weSentCodeTo')} +94 ${widget.mobile}',
              ...
              Center(
                child: _resendCooldown > 0
                    ? Text(
                        '${t('resendCodeIn')} ${_resendCooldown}s',
