...
class _ProfileDetailsScreenState extends State<ProfileDetailsScreen> {
  ...
  Future<void> _save() async {
    ...
    try {
      ...
      // completeRegistration's response doesn't include baasProfile,
      // so saving it directly to the local cache above would wipe
      // out the services/rate/about/location this screen just saved
      // server-side. Re-fetching the full user here (GET /api/users/me,
      // which does include baasProfile) before _load() re-reads the
      // cache is what makes the just-saved values actually show up
      // instead of stale/empty ones.
