    ...
    final choice = await showDialog<String>(
      ...
      builder: (context) => AlertDialog(
        ...
        content: Text(
          ...
          'Pay it to go back online.',
        ),
        actions: [
          TextButton(onPressed: () => Navigator.of(context).pop(null), child: const Text('Not Now')),
          TextButton(onPressed: () => Navigator.of(context).pop('wallet'), child: const Text('Pay from Wallet')),
          TextButton(onPressed: () => Navigator.of(context).pop('card'), child: const Text('Pay by Card')),
        ],
      ),
    );
