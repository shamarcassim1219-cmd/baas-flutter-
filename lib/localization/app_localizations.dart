...
class AppLocalizations {
  ...
  static const Map<String, Map<String, String>> _strings = {
    ...
    // ---- Complaints ----
    'complaints': {'en': 'Complaints', 'si': 'පැමිණිලි', 'ta': 'புகார்கள்'},
    'noComplaints': {'en': 'No complaints filed against you.', 'si': 'ඔබට එරෙහිව පැමිණිලි නැත.', 'ta': 'உங்களுக்கு எதிராக புகார்கள் இல்லை.'},

    // ---- OTP resend ----
    'resendCode': {'en': 'Resend Code', 'si': 'කේතය නැවත එවන්න', 'ta': 'குறியீட்டை மீண்டும் அனுப்பு'},
    'resendCodeIn': {'en': 'Resend code in', 'si': 'නැවත එවීමට', 'ta': 'மீண்டும் அனுப்ப'},
    'codeSentAgain': {'en': 'Code sent again.', 'si': 'කේතය නැවත එවා ඇත.', 'ta': 'குறியீடு மீண்டும் அனுப்பப்பட்டது.'},
  };
