...
class LocaleController extends ChangeNotifier {
  ...
  Future<void> setLanguage(String code) async {
    ...
    // Best-effort sync to the backend so server-generated text
    // (push notifications, the T&C agreement email) matches what's
    // picked here too - never blocks the local choice on this.
    try {
